...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Absensi</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <?php
                                    $db=dbConnect();
                                    $total = $db->query("SELECT * FROM absensi");
                                ?>
                                <li class="ms-auto"><span class="counter text-success"><?php echo $total->num_rows; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <?php
                                    $db=dbConnect();
                                    $total = $db->query("SELECT * FROM karyawan");
                                ?>
                                <li class="ms-auto"><span class="counter text-purple"><?php echo $total->num_rows; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Tanggal Sekarang</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                    <div id=""><canvas width="67" height="30"
                                            style="display: inline-block; width: 67px; height: 30px; vertical-align: top;"></canvas>
                                    </div>
                                </li>
                                <li class="ms-auto"><span class="counter text-info"><?= date('Y-m-d')?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container-fluid text-center"> 
                    Selamat Datang Di Sistem Informasi Absensi Karyawan
                </div>
        ...
        <footer class="footer text-center"> 2022 © Badut Kelompok 2
            </footer>
        <!-- ============================================================== -->
        <!-- End Page wrapper  -->
        <!-- ============================================================== -->
